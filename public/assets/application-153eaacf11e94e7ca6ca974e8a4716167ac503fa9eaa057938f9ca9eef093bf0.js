...
$(document).ready(function() {
  ...
  $(".rslides").responsiveSlides({
    ...
    $(" .flash-message.alert,  .flash-message.notice" ).delay(2000).slideUp(500, function(){
      $(this).alert('close');
  });

  function messageFlasher(message, type){
    var delay = 2000;
    ...
    if( typeof message !== "undefined" ){
        ...
        $.each(message, function(i, m){
            m.type = (typeof m.type === "undefined")? "" : " " + m.type.toLowerCase();
            messages.append('<div class="row"><div class="small-12 column"><div class="flash-message callout' + m.type + '">' + m.text + '</div></div></div>');
        });
    }

    messages.children().fadeIn();
    messages.children().delay(delay).fadeOut().queue(function(){
        messages.empty().dequeue();
    });
}
});
/** AnimateDialog.js | 1.0.0 | http://www.georgelee.me/project/animateddialogjs */
